...
def generate_context_for_ide(profile: PersonalityProfile, ide_type: str) -> str:
    ...
    if ide_type.lower() == "cursor":
        return format_cursor_context(base_context, profile)
    elif ide_type.lower() == "claude":
        return format_claude_context(base_context, profile)
    elif ide_type.lower() == "windsurf":
        return format_windsurf_context(base_context, profile)
    elif ide_type.lower() == "vscode":
        return format_vscode_context(base_context, profile)
    else:
        return format_generic_context(base_context, profile)
...
## Integration Notes
This personality context is designed to work with Cursor's AI assistant."""
...
---
*This configuration enhances Claude's responses with the personality traits of {profile.name}.*"""
...
This personality context integrates with Windsurf's AI capabilities."""
...
// Note: Integration method depends on your AI extension"""
...
## Usage Instructions
Copy this context into your AI assistant's system prompt or configuration."""
